...
ROOT_URLCONF = 'lite_cms_core_sample.urls'
...
WSGI_APPLICATION = 'lite_cms_core_sample.wsgi.application'
...
SEARCH_MODEL_CHOICES = (
    'lite_cms_core_sample.BaseItem',
    'lite_cms_core_sample.ContentItem',
)
